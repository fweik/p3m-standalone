...
p3mstandalone: charge-assign.o common.o error.o ewald.o interpol.o io.o main.o p3m-common.o p3m-error.o p3m-ik.o realpart.o timings.o Makefile main.c main.h
	$(CC) $(LFLAGS) charge-assign.o common.o error.o ewald.o interpol.o io.o main.o p3m-common.o p3m-error.o p3m-ik.o realpart.o main.c -o p3m
